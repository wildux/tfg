...
\date{\vspace{-0.1cm}23 d'abril de 2017}
...
\begin{document}
	...
	\begin{frame}{Introducció}
		...
		\begin{block}{Objectiu}
			Dissenyar i desenvolupar un sistema d'autolocalització per a robots mòbils usant algorismes de visió.
		\end{block}
		...
		%	\item Homografia
			...
			\item Posició de la regió seleccionada en la imatge del robot
